...
const Detail = () => {
  const { id } = useParams();
  const { item, setItem } = useStateProductDetail();
  ...
  useEffect(() => {
    ...
    // Limpia el estado cuando el componente se desmonta para evitar memory leaks
    return () => {
      setItem(null);
    };
  }, [id]);
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img
            ...
            src={
              item.imagenes && item.imagenes.length > 0 ? item.imagenes[0] : ""
            }
          ></img>
